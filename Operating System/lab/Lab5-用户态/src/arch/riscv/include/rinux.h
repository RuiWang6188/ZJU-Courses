#pragma once
#include "types.h"
#define PHY_START    0x80000000L // kernel physic start
#define PHY_END      (PHY_START + 16*1024*1024) // kernel physic ending
...
//#define KERNEL_STACK_TOP_VA  PAGE_OFFSET + 16*1024*1024 - PAGE_SIZE
...
#define USTACK_TOP 0xffffffdf80000000
