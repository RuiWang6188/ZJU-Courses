...
%
    ...
    show_result(x_k, error, alpha, iter, 'steepest descent', x_0);
    [x_k, error, alpha, iter] = backtracking_line_search(x_0, 'newton method', alpha_orig, rho, c);
    show_result(x_k, error, alpha, iter, 'newton method', x_0);
    ...
    show_result(x_k, error, alpha, iter, 'steepest descent', x_1);
    [x_k, error, alpha, iter] = backtracking_line_search(x_1, 'newton method', alpha_orig, rho, c);
    show_result(x_k, error, alpha, iter, 'newton method', x_1);
