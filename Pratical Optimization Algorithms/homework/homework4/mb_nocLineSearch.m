function alpha = mb_nocLineSearch(x,dir,slope0,of)
...
while 1
    ...
    if  ((of > of_0 + slope0*c1*alpha_1) || ((of >= of_x ) && (iter > 0)))
        ...
        % (because c1 > c2)
        alpha = nocZoom(x,dir,slope0, alpha_0, alpha_1,of_0,of_x ,c1,c2);
        break;
    end
    ...
    if (slopec >= 0)
        % there has to be an acceptable point between alpha_0 and alpha_1
        alpha = nocZoom(x,dir,slope0,alpha_1 , alpha_0,of_0,  of,c1,c2);
        break;
    end
...
function alpha = nocZoom(x,dir,slope0,alphaLo,alphaHi,of_0,ofLo,c1,c2)
